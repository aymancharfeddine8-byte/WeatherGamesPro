...
public class MathGameActivity extends AppCompatActivity implements MathPathView.OnPathListener {

    private TextView tvTarget, tvCurrent, tvScore, tvBest;
    private ProgressBar pbTimer;
    private MathPathView mathPathView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mathPathView = findViewById(R.id.mathPathView);

        mathPathView.setOnPathListener(this);
